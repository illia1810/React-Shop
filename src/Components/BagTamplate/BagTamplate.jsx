...
import "./BagTamplate.css"
import BagItem from "./BagItem";
import AppContext from "../../context";

const BagTamplate = ({onClose}) => {
    ...
    const itemsInBagFilter = bagItems.filter(item => item.count > 0);

    return (
        <div className="bag-tamplate">
            ...
            <div className="bag-items">
                ...
                {
                    bagItems && itemsInBagFilter.length === 0
                    ?
                        <div className="bag-empty">
                        <h1>No items in your bag...</h1>
                        </div>
                    :
                        bagItems && itemsInBagFilter.map((item) => {
                            return (
                                <BagItem
                                    key={item.id}
                                    item={item}
                ...
                {total > 0
                    ?
                    <h3 className="bag-total">Total: {total} $
                    </h3>
                    :
                    null
                }
